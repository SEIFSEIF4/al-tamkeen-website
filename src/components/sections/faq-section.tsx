...
const faqs = [
  {
    ...
    answer:
      "لا يشترط وجود فكرة جاهزة، فالمشروع يساعد الجمعيات على اكتشاف وبناء الفكرة الريادية.",
  },
  {
    question: "هل يشترط وجود خبرة تقنية للجمعية؟",
    answer: "لا يُشترط، فالمشروع يوفر الدعم التقني لتطوير المنتج.",
  },
  {
    question: "هل المشروع مخصص لنوع معين من الجمعيات؟",
    answer: "المشروع متاح لمختلف الجمعيات الأهلية في مختلف المجالات.",
  },
  {
    question: "هل يتطلب المشروع التفرغ الكامل؟",
    answer:
      "يتطلب مشاركة الفريق في الأنشطة التدريبية والتطويرية وجميع محاور المشروع وفق جدول المشروع.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "نعم، إذا كانت الفكرة تتطلب منتجًا تقنيًا، سيتم تطويره ضمن المشروع.",
  },
  {
    question: "هل المشروع مدفوع؟",
    answer: "المشروع مدعوم بالكامل، ولا يتطلب أي رسوم مالية للمشاركة.",
  },
];

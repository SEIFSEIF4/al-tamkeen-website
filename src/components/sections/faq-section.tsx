...
const faqs = [
  {
    question: "هل البرنامج مخصص للجمعيات فقط؟",
    answer:
      "نعم، البرنامج مصمم خصيصاً لتمكين الجمعيات الأهلية المسجلة في المملكة.",
  },
  {
    question: "هل يشترط وجود فكرة جاهزة؟",
    answer:
      "لا يشترط وجود فكرة جاهزة، فالبرنامج يساعد الجمعيات على تطوير أفكار ريادية مبتكرة.",
  },
  {
    question: "هل يتطلب البرنامج تفرغًا كاملًا؟",
    answer:
      "يتطلب البرنامج تفرغًا جزئيًا من الفريق المشارك لضمان الالتزام بمراحل البرنامج ومخرجاته.",
  },
  {
  ...
  {
    question: "هل الشركة ستكون مستقلة عن الجمعية؟",
    answer: "نعم، مع وجود حوكمة واضحة تضمن العلاقة النظامية بين الطرفين.",
  },
];

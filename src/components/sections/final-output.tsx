...
const outputs = [
  {
    id: 1,
    title: "شركة ناشئة مستدامة",
    description: "تحويل الجمعية إلى شركة قائمة بذاتها",
    icon: (
      <svg
        className="w-12 h-12"
        fill="none"
  ...
  },
  {
    ...
    description: "خطة عمل متكاملة للاستدامة والنمو",
    icon: (
      <svg
        className="w-12 h-12"
        fill="none"
  ...
  {
    id: 3,
    title: "فريق قيادي مؤهل",
    description: "كوادر مدربة على إدارة الشركات الناشئة",
    icon: (
      <svg
        className="w-12 h-12"
        fill="none"
  ...
  },
  {
    ...
    description: "علاقات مع مستثمرين وشركاء محتملين",
    icon: (
      <svg
        className="w-12 h-12"
        fill="none"
